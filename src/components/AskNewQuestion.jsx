            ...
            <div className="max-w-4xl mx-auto">
               ...
               <div className="bg-gray-800/90 border border-gray-700 rounded-3xl p-8 shadow-2xl">
                  <div className="space-y-8">
                     ...
                     {/* Submit Message */}
                     {submitMessage && (
                        <div className={`text-center p-3 rounded-lg ${submitMessage.includes('successfully')
                     ...
                     <div className="flex justify-center pt-2 sm:pt-4">
                        <button
                           ...
                           className={`relative group px-12 py-4 rounded-2xl text-white font-semibold text-lg shadow-2xl transition-all duration-300 overflow-hidden ${isSubmitting
